...
using namespace std;
string DIALOGUE_PATH = "/home/HotSauceUseName/Documents/Actually Programmed Software/Weather Everything/Weather Code/V009/Dialogue/";
	...
	int x;
		...
		case 2:{
			...
			if(DQptr->getQuestCompletedStatus() == true){
				...
				string test = DIALOGUE_PATH += "Diaper Quest 001/First Pre Talk.txt";
				//cout << "Test file path is: \n" << test <<endl;
				//cout << "which should be the same as: \n";
				//cout << "/home/HotSauceUseName/Documents/Actually Programmed Software/Weather Everything/Weather Code/V009/Dialogue/Diaper Quest 001/First Pre Talk.txt" <<endl; 
		...
		case 5:{
			...
			//Port
			cout << "AJD: Temp location meant for checking quest stuff\n\n";
			
			cout << "You see an unconsious woman, it is as though she's in  a coma.\n";
			cout << "\"Maybe she needs a true love's kiss.\" says Mary.\n";
			if(lifeGuardInParty == true && Girl1.getSexualityExternal() > 1 ){
					cout << "\"Hmm. I don't know about that, but let me try something...\" the life guard says as she walks over.";
			}
		...
		case 7:{
			...
			// =========>Handle here
					...
					cout << "";
					cout << "You arrive at a nude beach. Nudity is enforced. What do you do?\n";
					cout << "What do you do?\n";
					options = {"Strip all clothes", "Leave"};
				choiceA = displayChoiceVector(options);
				//if (choiceA == 1 && girl = lifeguard)
				cout << "AJD DEBUG: Girl type = " << Girl1.getType()<<endl;;
				if (choiceA == 1 && Girl1.getType() == "Life guard"){
					cout << "AJD: See \"Handle Interact big\". Aprox line 868\n\n";
					cout << "AJD: Girl1.getType() = " << Girl1.getType()<<endl;;
					cout << "You and your party are playing in the waves.\n You notice that Mary is nowhere to be seen.\n";
					
					string tempStringHeight = " ";
					if(Girl1.getHeight() >=72){
							tempStringHeight = " tall " ;
					}else if(Girl1.getHeight() < 60){
							tempStringHeight = " short ";
					}
					
					string tempStringBusty = " ";
					if(Girl1.getBreastSize() == "D" ||Girl1.getBreastSize() == "DD" || Girl1.getBreastSize() == "E"){
						tempStringBusty = " busty ";
					}
					
					
					cout << "You see a" << tempStringHeight << tempStringBusty << "woman sprinting towards you. She jumps into the water and pulls mary out.\n";
					if(Girl1.getSexualityExternal() > 1){
						cout << "This woman straddles Mary and starts performing mouth to mouth.\n\"Her airway may be clogged.\" You can see her stick her tongue deep down Mary's throat.\n";
					} else{
...
DIALOGUE_PATH = "/home/HotSauceUseName/Documents/Actually Programmed Software/Weather Everything/Weather Code/V009/Dialogue/";
